      ...
      let theoremName = "multi_proof_thm"
          ...
          wrongIdTheoremEnv =
            extendTheoremEnvironment
              ...
              (PVar "wrong_id_axiom" 0 dummyPos)
              theoremEnv
      ...
      let theoremName = "nested_subst_thm"
          ...
          wrongComplexAxiomEnv =
            extendTheoremEnvironment
              ...
              (PVar "wrong_complex_ax" 0 dummyPos)
              theoremEnv
